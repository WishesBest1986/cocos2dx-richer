...
RichPlayer* RichPlayer::create(std::string name, int tag, bool enemy, int money, int strength)
{
...
bool RichPlayer::init(std::string name, int tag, bool enemy, int money, int strength)
{
    this->setTag(tag);
    addPlayerAnimation();
    char fileName[20];
...
void RichPlayer::addPlayerAnimation()
{
