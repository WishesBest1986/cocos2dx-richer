...
#ifndef __richer__RicherPlayer__
#define __richer__RicherPlayer__
...
public:
    ...
    static RicherPlayer* create(std::string name, int tag, bool enemy, int money = 50000, int strength = 100);
...
#endif /* defined(__richer__RicherPlayer__) */
